...
#jiwoo
class FollowLeadingVehicleWithoutIntersection(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._first_vehicle_speed = 13.88
        self._reference_waypoint = self._map.get_waypoint(config.trigger_points[0].location)
        self._other_actor_max_brake = 1.0
        self._other_actor_stop_in_front_location = 20
        self._other_actor_transform = None
        # Timeout of scenario in seconds
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, 1000, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
    ...
    def _create_behavior(self):
        ...
        # reset its pose to the required one
        start_transform = ActorTransformSetter(self.other_actors[0], self._other_actor_transform)
        logging.info('Transform of front vehicle is '+str(self._other_actor_transform))
        # let the other actor drive until next intersection
        # @todo: We should add some feedback mechanism to respond to ego_vehicle behavior
        driving_to_target_location = py_trees.composites.Parallel(
            "DrivingTowardsLocation",
            policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)

        driving_to_target_location.add_child(WaypointFollower(self.other_actors[0], self._first_vehicle_speed))
        driving_to_target_location.add_child(InTriggerDistanceToLocation(
            self.other_actors[0], target_location=random.choice(self.stop_locations), distance=self._other_actor_stop_in_front_location))
        ...
        sequence = py_trees.composites.Sequence("Sequence Behavior")
        sequence.add_child(start_transform)
        sequence.add_child(driving_to_target_location)
        sequence.add_child(LoggingProgress("vehicle stopping"))
        sequence.add_child(stop)
        sequence.add_child(LoggingProgress("vehicle stopped"))
        sequence.add_child(endcondition)
        sequence.add_child(ActorDestroy(self.other_actors[0]))
...
#jiwoo
class FollowLeadingVehicleWithoutIntersection1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        # Timeout of scenario in seconds
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, -500, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection1, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
...
#jiwoo
class FollowLeadingVehicleWithoutIntersection2(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        # Timeout of scenario in seconds
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, -250, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection2, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
...
#jiwoo
class FollowLeadingVehicleWithoutIntersection3(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        # Timeout of scenario in seconds
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, 0, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection3, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
...
#jiwoo
class FollowLeadingVehicleWithoutIntersection4(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, 250, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection4, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
...
#jiwoo
class FollowLeadingVehicleWithoutIntersection5(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, 500, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection5, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
...
#jiwoo
class FollowLeadingVehicleWithoutIntersection6(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        # Timeout of scenario in seconds
        self.timeout = timeout
        self.stop_locations = [carla.Location(-1.75, -700, 0.6)] # jiwoo
        super(FollowLeadingVehicleWithoutIntersection6, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
